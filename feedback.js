(function(){'use strict';
var ss='.fb{position:fixed;right:20px;bottom:20px;z-index:9998;border-radius:22px;padding:8px 14px;background:var(--accent,#1a3a5c);color:#fff;border:0;cursor:pointer;font-size:14px;display:flex;align-items:center;justify-content:center;gap:4px;box-shadow:0 12px 30px rgba(0,0,0,.28)}@media(max-width:480px){.fb{right:10px;bottom:10px;padding:6px 10px;font-size:12px;border-radius:16px;gap:2px}}.fm{position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.35);display:none;align-items:center;justify-content:center}.fm.s{display:flex}.fd{background:#fff;border-radius:14px;padding:20px;max-width:400px;width:92%;max-height:85vh;overflow-y:auto;font:14px system-ui,"PingFang SC","Microsoft YaHei",sans-serif;color:#1f2937;box-shadow:0 20px 60px rgba(0,0,0,.22)}.fd h3{margin:0 0 4px;font-size:1rem;color:#111827}.fd .fu{margin:0 0 10px;color:#374151;line-height:1.55}.fd label{display:block;font-weight:700;margin:8px 0 2px;color:#111827}.fd input,.fd select,.fd textarea{width:100%;padding:6px 10px;border:1px solid #cbd5e1;border-radius:8px;box-sizing:border-box;color:#111827;background:#fff}.fd input::placeholder,.fd textarea::placeholder{color:#6b7280;opacity:1}.fd textarea{min-height:68px}.fd .fa{display:flex;justify-content:flex-end;margin-top:12px}.fd .fa button{padding:6px 16px;border:0;cursor:pointer;font-weight:600}.fd .fs{background:var(--accent,#1a3a5c);color:#fff}.fd .fc{background:#e5e7eb;color:#1f2937}.fd .fp{font-size:.72rem;color:#4b5563;margin-top:10px;text-align:center;line-height:1.6}.ft{position:fixed;bottom:80px;left:50%;transform:translateX(-50%);z-index:10000;background:#333;color:#fff;padding:6px 16px;border-radius:20px;opacity:0;pointer-events:none}.ft.s{opacity:1}';
...
o.innerHTML='<div class="fd"><h3>💬 反馈与建议</h3><p class="fu">遇到 Bug、体验不顺或想加梗，都可以直接告诉我。</p><label>类型</label><select id="ftyp"><option value="bug">Bug 报告</option><option value="feature">功能建议</option><option value="improvement">改进建议</option><option value="other">其他</option></select><label>标题</label><input id="ftit" maxlength="200" placeholder="简要描述"><label>详细内容</label><textarea id="fct" maxlength="2000" placeholder="请描述你的问题、建议或当时发生了什么"></textarea><label>联系方式（选填）</label><input id="fcn" maxlength="100" placeholder="邮箱或微信"><div class="fa"><button class="fc" id="fcc">取消</button><button class="fs" id="fsb">提交反馈</button></div><p class="fp">点击操作会做匿名统计并存到云端用于改进产品，你填写的联系方式仅在你主动提供时提交。</p></div>';
